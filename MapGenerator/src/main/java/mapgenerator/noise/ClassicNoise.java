...
public class ClassicNoise {
	...
	/**
	 * Perlin noise fade function, returns 6x^5 - 15x^4 + 10x^3. Eases the
	 * coordinate values, so they will ease towards integral values.
	 *
	 * @param x
	...
	/**
	 * increments the value, if the repeat value is over 0, we return the
	 * remainder of x+1
	 *
	 * @param x
	 ...
	 * Uses the bitwise and operator, from the hash and from the value 15.
	 *
	...
	/**
	 * Calculates noise from three values, improved Perlin Noise. Input can't be
	 * whole numbers.
	 *
	 * @param x
	 * @param y
	...
	/**
	 * Repeats the perlinSecond method for "octaves" times. Applies amplitudes,
	 * frequency and persistence to the input values. Amplitude affects how big
	 * the height differences are. Frequency affects how frequent the height
	 * differences are.
	 *
	 * @param x
	 * @param y
	 ...
	 * @param persistence how much influence previous octaves have on the new
	 * noise.
